...
package com.lbs.re.data.config;
 ...
 * com.lbs.re.data.repository for repository operations and package com.lbs.re.data.dao for DAO implementations.
 */
@Configuration
@EnableJpaRepositories(basePackages = {"com.lbs.re.data.repository"})
...
public class DataConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, JpaVendorAdapter adapter, Properties additionalProperties) {
        ...
        emf.setPackagesToScan("com.lbs.re.model", "com.lbs.re.util");
