...
public class DateTimeUtils {
	...
	public static String getResourceEditordbFormatSystemDateAsString() {
		DateFormat formatter = new SimpleDateFormat(Constants.RESOURCEEDITOR_DB_DATE_FORMAT);
		Date date = new Date();
		return formatter.format(date);
	}

	public static String getResourceEditorFormatSystemDate() {
		Date date = new Date();
		DateFormat formatter = new SimpleDateFormat(Constants.RESOURCEEDITOR_DATE_FORMAT);
		return formatter.format(date);
	}
